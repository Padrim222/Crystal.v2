...
export const CircularTestimonials = ({
  ...
  // Color & font config with Crystal theme
  ...
  const colorArrowBg = colors.arrowBackground ?? "hsl(var(--coral))";
  const colorArrowFg = colors.arrowForeground ?? "hsl(var(--coral-foreground))";
  const colorArrowHoverBg = colors.arrowHoverBackground ?? "hsl(var(--crimson))";
