    ...
    >
      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div className="flex items-center gap-3">
          <Settings className="h-6 w-6 md:h-8 md:w-8 text-coral" />
          <h1 className="text-xl md:text-3xl font-bold text-foreground">
            <span className="hidden md:inline">Personalização da Crystal</span>
            <span className="md:hidden">Crystal</span>
          </h1>
        </div>
        <div className="flex gap-2">
          ...
          <Button onClick={saveSettings} disabled={saving} size="sm">
            ...
            {saving ? "..." : <span className="hidden sm:inline">Salvar</span>}
          </Button>
        </div>
      </div>

      <Tabs defaultValue="personality" className="space-y-4 md:space-y-6">
        <TabsList className="grid w-full grid-cols-3 h-9 md:h-10">
          <TabsTrigger value="personality" className="text-xs md:text-sm">Personalidade</TabsTrigger>
          <TabsTrigger value="behavior" className="text-xs md:text-sm">Comportamento</TabsTrigger>
